  ...
  return (
    <main>
      <div className="font-cbyg flex flex-col h-screen bg-orange-300 overflow-hidden">
        ...
        <div className="flex justify-center -mt-15 ml-160 relative w-fit h-fit group">
          <div className="w-20 h-20 bg-contain bg-no-repeat" style={{ backgroundImage: `url('${playIconStatic}')` }}>
            <div className="absolute w-24 h-24 -inset-2 opacity-0 transition-opacity group-hover:opacity-100 bg-contain bg-no-repeat" style={{ backgroundImage: `url('${playIconGif}')` }}></div>
          </div>
        </div>
      </div>
    </main>
